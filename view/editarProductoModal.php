<!-- Modal -->
<div class="modal fade" id="editarRegistroProducto" tabindex="-1" aria-labelledby="editarRegistroProductoLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editarRegistroProductoLabel">Modificar Producto</h1>
